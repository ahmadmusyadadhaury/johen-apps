...
class User extends Authenticatable
{
    ...
    {
        return match (true) {
            $this->isKoordinatorPubg() => 'PUBG',
            $this->isKoordinatorFf() => 'Free Fire',
            $this->isKoordinatorMlbb() => 'MLBB',
            $this->isKoordinatorEfootball() => 'E-football',
            $this->isKoordinatorValorant() => 'Valorant',
            $this->isKoordinatorRoblox() => 'Roblox',
            $this->isKoordinatorMonkeyPubg() => 'Monkey PUBG',
            ...
            $this->isStaffHostPubg() => 'PUBG',
            $this->isStaffHostFf() => 'Free Fire',
            $this->isStaffHostMlbb() => 'MLBB',
            $this->isStaffHostEfootball() => 'E-football',
