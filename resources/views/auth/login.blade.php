        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5"
            ...
            <div x-data="{ show: false }" class="login-stagger-2 motion-reduce:opacity-100">
                ...
                <div class="relative">
                    ...
                    <button type="button" @click="show = !show" :aria-label="show ? 'Sembunyikan password' : 'Tampilkan password'" class="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 text-gray-400 hover:text-gray-700 dark:text-gray-500 dark:hover:text-gray-300 transition-all rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500">
            ...
            <div class="login-stagger-3 motion-reduce:opacity-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
                <label for="remember_me" class="flex items-center gap-2 cursor-pointer select-none">
                    <input id="remember_me" type="checkbox" class="rounded-lg bg-white border-gray-300 text-primary-600 shadow-sm focus:ring-primary-500/50 transition-all duration-200 motion-reduce:transition-none dark:bg-white/5 dark:border-white/20 dark:text-primary-500" name="remember">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Ingat saya</span>
                </label>
                <button type="button" @click="showForgotModal = true" class="text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
                    Lupa password?
                </button>
            </div>
            ...
            <div class="login-stagger-5 motion-reduce:opacity-100">
                <p class="text-center text-sm text-gray-500">
                    Belum punya akun?
                    <a href="https://wa.me/6285156521726" target="_blank" rel="noopener noreferrer" class="font-semibold text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">Hubungi admin</a>
                </p>
            </div>
        </form>
        ...
        <template x-teleport="body">
            <div x-show="showForgotModal" x-cloak
                ...
                <div x-show="showForgotModal"
                    ...
                    class="relative w-full max-w-md rounded-2xl bg-white border border-gray-100 p-8 shadow-2xl dark:bg-[#141822] dark:border-white/10">
                    {{-- Icon --}}
                    <div class="mx-auto mb-5 w-14 h-14 rounded-full bg-primary-500/10 flex items-center justify-center">
                        <svg class="w-7 h-7 text-primary-600 dark:text-primary-400" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
                    </div>
                    <h3 class="text-lg font-display font-semibold text-gray-900 dark:text-white text-center mb-2">Lupa Password?</h3>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <button type="button" @click="showForgotModal = false"
                            class="w-full px-5 py-2.5 rounded-xl border border-gray-200 hover:bg-gray-50 text-gray-600 hover:text-gray-900 text-sm transition-all duration-200 dark:border-white/10 dark:hover:bg-white/5 dark:text-gray-400 dark:hover:text-white">
                            Tutup
                        </button>
                    </div>
                </div>
