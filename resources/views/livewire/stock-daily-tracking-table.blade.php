@push('topbar-left')
    <div>
        <h1 class="text-base sm:text-lg font-bold text-gray-900 dark:text-gray-100 truncate">Daily Tracking</h1>
        <p class="hidden sm:block text-xs text-gray-400 mt-0.5">Tracking penjualan harian</p>
    </div>
@endpush
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                        ...
                        <td class="table-cell text-center">
                            @php
                                $isKoord = auth()->user()->isKoordinatorStock();
                                $isStaff = auth()->user()->isStaffStock();
