...
<div x-data="{ confirmAction: false, confirmTitle: '', confirmMessage: '', confirmHandler: null, filtersOpen: false, detailOpen: false, selected: null }">
    ...
    @endif
        ...
        <div class="cuti-stats-grid grid grid-cols-2 md:grid-cols-2 {{ $jatahAvailable ? 'lg:grid-cols-4' : 'lg:grid-cols-3' }} gap-3 sm:gap-5 mb-6">
            ...
            <div class="cuti-stats-leave stat-card group relative overflow-hidden">
                <div class="flex items-center justify-between mb-3">
            ...
            @if($jatahAvailable)
            <div class="cuti-stats-entitlement stat-card group relative overflow-hidden">
                <div class="flex items-center justify-between mb-3">
            ...
            <div class="cuti-stats-pending cuti-stats-compact stat-card group">
                <div class="flex items-center justify-between mb-3">
