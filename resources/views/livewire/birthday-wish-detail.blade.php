@push('topbar-left')
    <div>
        <h1 class="text-base sm:text-lg font-bold text-gray-900 dark:text-gray-100 truncate">Detail Ucapan Ulang Tahun</h1>
        <p class="hidden sm:block text-xs text-gray-400 mt-0.5">Semua ucapan untuk {{ $employee->nama }}</p>
    </div>
@endpush
