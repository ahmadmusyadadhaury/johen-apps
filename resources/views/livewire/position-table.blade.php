...
<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5 mb-6">
        <div class="stat-card group">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ number_format($totalPositions, 0, ',', '.') }}</p>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Total Jabatan</p>
        </div>

        <div class="stat-card group">
            <div class="flex items-center justify-between mb-3">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-lg shadow-emerald-200 group-hover:scale-110 transition-transform duration-300">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ number_format($activePositions, 0, ',', '.') }}</p>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Jabatan Aktif</p>
        </div>
        ...
        <div class="stat-card group">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ number_format($inactivePositions, 0, ',', '.') }}</p>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Jabatan Nonaktif</p>
        </div>
    </div>
            ...
            <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                @forelse($positions as $pos)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900 transition-colors">
                        <td class="table-cell text-center text-gray-500 dark:text-gray-400">{{ $positions->firstItem() + $loop->index }}</td>
                        <td class="table-cell">
