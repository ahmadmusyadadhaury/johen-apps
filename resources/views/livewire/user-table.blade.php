@push('topbar-left')
    <div>
        <h1 class="text-base sm:text-lg font-bold text-gray-900 dark:text-gray-100 truncate">Kelola Akun</h1>
        <p class="hidden sm:block text-xs text-gray-400 mt-0.5">Atur akun pengguna aplikasi</p>
    </div>
@endpush
...
<option value="koordinator">Koordinator</option>
                    ...
                    <option value="koordinator_project">Koordinator Project</option>
                    ...
                    @forelse($users as $u)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900 transition-colors">
                            ...
                            <td class="table-cell">
                                ...
                                @elseif($u->role === 'koordinator_project')
                                    <span class="badge-info">Koordinator Project</span>
                                @else
...
<x:confirm-delete-modal title="Hapus Akun" message="Apakah Anda yakin ingin menghapus akun ini?" />
        ...
        @if($users->hasPages())
            <div class="px-6 py-3 border-t border-gray-50 dark:border-gray-800">
                {{ $users->links('pagination.blue-active') }}
            </div>
        @endif
    </div>
