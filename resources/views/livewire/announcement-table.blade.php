...
<div>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center justify-end gap-3">
                                ...
                                <button wire:click="confirmDelete({{ $announcement->id }})" class="text-xs text-red-500 hover:text-red-700 dark:text-red-400 font-medium">Hapus</button>
                            </div>
                        </td>
                    </tr>
                    @empty
    ...
    <div x-data="{ open: $wire.entangle('showDeleteConfirmModal') }"
        ...
        <div @click.stop class="relative w-full max-w-sm rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-2xl my-10">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 text-center mb-6">Apakah Anda yakin ingin menghapus pengumuman ini? Tindakan ini tidak dapat dibatalkan.</p>
