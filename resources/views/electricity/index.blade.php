<x-app-layout title="Pembayaran Listrik">
    @push('topbar-left')
        <div>
            <h1 class="text-base sm:text-lg font-bold text-gray-900 dark:text-gray-100 truncate">Pembayaran Listrik</h1>
            <p class="hidden sm:block text-xs text-gray-500 dark:text-gray-400">Kelola token listrik dan pengecekan</p>
        </div>
    @endpush

    @push('topbar-right')
        <div class="flex items-center gap-2">
            <span class="hidden sm:inline text-xs text-gray-500 dark:text-gray-400">Kapasitas: {{ number_format($setting->kapasitas_kwh, 0, ',', '.') }} KWH/bulan</span>
